...
```md
---
'@koikorn/adapter-mongoose': patch
...
1. Checkout the tag of the release
   ...
   Let's say the package being patched is `@koikorn/keystone`, then we
   want to run:

   ```sh
   git checkout -b backport-keystone-14.0.1 @koikorn/keystone@14.0.1
   ```
...
5. Publish the newly version bumped package
   ...
   ```sh
   (\
   export PACKAGE_NAME=@koikorn/keystone && \
   export OTP_CODE= && \
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/jaredcrowe"><img src="https://avatars1.githubusercontent.com/u/4995433?v=4" width="80px;" alt=""/><br /><sub><b>Jared Crowe</b></sub></a><br /><a href="https://github.com/lorenhaim/keystone/commits?author=jaredcrowe" title="Code">💻</a></td>
