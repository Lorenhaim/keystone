...
For an example of a custom field, please see the [Stars field](https://github.com/lorenhaim/keystone/tree/master/demo-projects/custom-fields/) in the basic test project.
