...
`@koikorn/keystone`, which is the core of Keystone, and
`@koikorn/adapter-mongoose`, which allows our app to connect to MongoDB:

```shell
yarn add @koikorn/keystone @koikorn/adapter-mongoose
```
