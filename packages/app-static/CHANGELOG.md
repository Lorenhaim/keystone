...
- [5598701f](https://github.com/lorenhaim/keystone/commit/5598701f): throwing errors when the StaticApp doesn't have a string valued passed to the "path" or "src" properties

## 1.1.0

### Minor Changes

- [fe23c719](https://github.com/lorenhaim/keystone/commit/fe23c719): Added a new fallback option to support client-side routing
