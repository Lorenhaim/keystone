...
- [700cd9c6](https://github.com/lorenhaim/keystone/commit/700cd9c6): NextApp: Throw an error if the 'dir' config option is not set. Also set the default config to an empty object.

### Patch Changes

- [7c0908d7](https://github.com/lorenhaim/keystone/commit/7c0908d7): Update documentation for NextApp
