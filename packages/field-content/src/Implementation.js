...
import { Relationship, Text } from '@koikorn/fields';
import { flatMap, unique, objMerge } from '@koikorn/utils';
...
export class Content extends Relationship.implementation {
   ...
   * two halves and send them seperately (see `@koikorn/field-views-loader`):
