# @koikorn/auth-passport

## 5.2.3

### Patch Changes

- [`5a757119d`](https://github.com/lorenhaim/keystone/commit/5a757119d7042bf13242f3a92fdde5b34ea1f71d) [#3219](https://github.com/lorenhaim/keystone/pull/3219) Thanks [@rubenamorim](https://github.com/rubenamorim)! - Fix invalid query result destructuring.
  These changes correct the regression introduced by the latest version (`5.2.2`).
- Updated dependencies [[`4ddc3dc6f`](https://github.com/lorenhaim/keystone/commit/4ddc3dc6f87c192627d00db85a1080411400eeb5), [`2806a0bdf`](https://github.com/lorenhaim/keystone/commit/2806a0bdfd65429e7c44ed070983f121d6934955), [`3adb2ac2a`](https://github.com/lorenhaim/keystone/commit/3adb2ac2ac4ab65636ffea1b2b1f7044410c2b8b)]:
...
- [`431cf76b0`](https://github.com/lorenhaim/keystone/commit/431cf76b054fda3e4fd43020acb1be579803577d) [#3163](https://github.com/lorenhaim/keystone/pull/3163) Thanks [@timleslie](https://github.com/timleslie)! - Updated to use `keystone.executeGraphQL` for all server-side GraphQL operations.
...
- [`72e117bce`](https://github.com/lorenhaim/keystone/commit/72e117bcea158e2d31b96856bda9e2fb392493af) [#2534](https://github.com/lorenhaim/keystone/pull/2534) Thanks [@frank10gm](https://github.com/frank10gm)! - Add passport authenticate options (eg. prompt: 'consent' to receive Google refresh_token)

### Patch Changes

- [`84fb3b95e`](https://github.com/lorenhaim/keystone/commit/84fb3b95ed88d02659e910262969cc84b5886ad1) [#2997](https://github.com/lorenhaim/keystone/pull/2997) Thanks [@timleslie](https://github.com/timleslie)! - Fixed bug with Google Oauth2 callback url not being correctly configured (#2362).
...
- [`2b3c7c26`](https://github.com/lorenhaim/keystone/commit/2b3c7c269caa57c2b2f2ecc2aacdb114799f088d) [#2628](https://github.com/lorenhaim/keystone/pull/2628) Thanks [@rjbernaldo](https://github.com/rjbernaldo)! - Updated documentation regarding password configuration and it's current support status.
...
* Updated dependencies [[`b6a555c2`](https://github.com/lorenhaim/keystone/commit/b6a555c28296394908757f7404b72bc6b828b52a), [`68be8f45`](https://github.com/lorenhaim/keystone/commit/68be8f452909100fbddec431d6fe60c20a06a700), [`61a70503`](https://github.com/lorenhaim/keystone/commit/61a70503f6c184a8f0f5440466399f12e6d7fa41)]:
...
- [b08c499e](https://github.com/lorenhaim/keystone/commit/b08c499e): Remove unnecessary `hostURL` and `apiPath` options from `PassportAuthStrategy` constructor thanks to usage of the new `keystone.executeQuery()` internally.

## 4.0.1

### Patch Changes

- [12668191](https://github.com/lorenhaim/keystone/commit/12668191): Fix assertion logic of cookieSecret deprecation message
...
- [b301fd0f](https://github.com/lorenhaim/keystone/commit/b301fd0f): `auth-passport`'s `onAuthenticated` method now receives an `isNewItem` flag to indicate if the user is logging for the first time or not.
...
- [ab0b1f22](https://github.com/lorenhaim/keystone/commit/ab0b1f22):
