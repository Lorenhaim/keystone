...
- [`25921ebe4`](https://github.com/lorenhaim/keystone/commit/25921ebe4d06652b03299fe4a516bd3d01de1800) [#3220](https://github.com/lorenhaim/keystone/pull/3220) Thanks [@singhArmani](https://github.com/singhArmani)! - **Fix**: delete function not passing required config params
...
- [`614164c58`](https://github.com/lorenhaim/keystone/commit/614164c5804b20800938efe781face46f5aea7bc) [#2967](https://github.com/lorenhaim/keystone/pull/2967) Thanks [@intmainvoid](https://github.com/intmainvoid)! - Providing an access key, secret access key or region directly to AWS has been deprecated (according to AWS). As such, parameters `accessKeyId`, `secretAccessKey` and `region` are no longer `required` on the S3Adapter's constructor and - if provided this way - are ignored by the S3Adapter. These parameters can however, still be provided via the optional `s3Options` parameter object if required like so:
...
- [`cced67b8f`](https://github.com/lorenhaim/keystone/commit/cced67b8f9785348d79b23a89405fcc474461c14) [#3073](https://github.com/lorenhaim/keystone/pull/3073) Thanks [@gautamsi](https://github.com/gautamsi)! - \* Replaced `stream.close` with `stream.destroy()` in s3 file-adapter as there is no `readableStream.close` method.
...
- [`04ec9981`](https://github.com/lorenhaim/keystone/commit/04ec998166a8b3044570769a8c3f501d80527bf9) [#2843](https://github.com/lorenhaim/keystone/pull/2843) Thanks [@Vultraz](https://github.com/Vultraz)! - Updated cloudinary dependency to 1.21.0.
...
- [`787eabb3`](https://github.com/lorenhaim/keystone/commit/787eabb387cd28f1578a5dfb68db95203ab8c782) [#2291](https://github.com/lorenhaim/keystone/pull/2291) Thanks [@LiamAttClarke](https://github.com/LiamAttClarke)! - Returned promise from file-adapter delete methods, made delete params consistent between adapters.
...
- [`8415f628`](https://github.com/lorenhaim/keystone/commit/8415f6289933cff244a592e1379ab70dfef926fc) [#2250](https://github.com/lorenhaim/keystone/pull/2250) - Added `getFilename` option to S3Adapter.

## 5.3.2

### Patch Changes

- [`9677dc17`](https://github.com/lorenhaim/keystone/commit/9677dc177b7b747397732700cab42d98e89f03f5) [#2249](https://github.com/lorenhaim/keystone/pull/2249) - Replaced s3.putObject with s3.upload

  Resolves https://github.com/lorenhaim/keystone/issues/2165
...
- [`129b0f6`](https://github.com/lorenhaim/keystone/commit/129b0f61f34adb7482901d2da4ddb14ce1aedd62) [#2092](https://github.com/lorenhaim/keystone/pull/2092) - Added S3 file adapter

## 5.2.0

### Minor Changes

- [`3d2c2b2e`](https://github.com/lorenhaim/keystone/commit/3d2c2b2e65943be0bd59e448d3237c3abe983b04) [#1953](https://github.com/lorenhaim/keystone/pull/1953) Thanks [@Vultraz](https://github.com/Vultraz)! - Added `delete()` method to file adapters.
...
- [d316166e](https://github.com/lorenhaim/keystone/commit/d316166e): Change FileAdapter API from: `{ route, directory }` to `{ path, src }` to match other packages.
...
- [patch][a62b869d](https://github.com/lorenhaim/keystone/commit/a62b869d):
