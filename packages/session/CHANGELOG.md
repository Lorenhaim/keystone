...
- [`2806a0bdf`](https://github.com/lorenhaim/keystone/commit/2806a0bdfd65429e7c44ed070983f121d6934955) [#3182](https://github.com/lorenhaim/keystone/pull/3182) Thanks [@Vultraz](https://github.com/Vultraz)! - Updated express-session to 1.17.1.
...
- [`61d0f428`](https://github.com/lorenhaim/keystone/commit/61d0f428097f8fe3c164d3d123ec5e4b5040a6fa) [#1773](https://github.com/lorenhaim/keystone/pull/1773) Thanks [@timleslie](https://github.com/timleslie)! - Cleanly handle the situation where an authed session item is no longer in the system.

## 3.0.2

### Patch Changes

- [a6d384b1](https://github.com/lorenhaim/keystone/commit/a6d384b1): Populate session item using `getAccessControlledItem()` rather than `findById()`.
...
- [patch][bf364bf0](https://github.com/lorenhaim/keystone/commit/bf364bf0):

  - Restructure internal code

## 1.0.1

- [patch][62e2d517](https://github.com/lorenhaim/keystone/commit/62e2d517):

  - Fix bug in session audiences

## 1.0.0

- [minor][d718c016](https://github.com/lorenhaim/keystone/commit/d718c016):
