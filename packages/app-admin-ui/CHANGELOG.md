...
- [`37f57c39a`](https://github.com/lorenhaim/keystone/commit/37f57c39ac490fa8a67499ac7ac75a8c04af41bf) [#3124](https://github.com/lorenhaim/keystone/pull/3124) Thanks [@Vultraz](https://github.com/Vultraz)! - Fixed a regression in the Create Relationship workflow.
...
* [`b61987552`](https://github.com/lorenhaim/keystone/commit/b619875520aa3b10d104794140f7977ffaebfbf0) [#2482](https://github.com/lorenhaim/keystone/pull/2482) Thanks [@gautamsi](https://github.com/gautamsi)! - Enabled the use of `listManageActions` hook in the Admin UI.
...
- [`ba363d9a8`](https://github.com/lorenhaim/keystone/commit/ba363d9a82d3ca3ec464547a5d9e38354bc2a172) [#2855](https://github.com/lorenhaim/keystone/pull/2855) Thanks [@Vultraz](https://github.com/Vultraz)! - Converted more React components to functional form.
...
- [`2a1e4f49`](https://github.com/lorenhaim/keystone/commit/2a1e4f49d7f234c49e5b04440ff786ddf3e9e7ed) [#2901](https://github.com/lorenhaim/keystone/pull/2901) Thanks [@Vultraz](https://github.com/Vultraz)! - Fixed Admin UI sometimes using the wrong auth mutation name.
...
* [`b14c07a1`](https://github.com/lorenhaim/keystone/commit/b14c07a154ae1cb92e7cbc87484d99419f92d649) [#2792](https://github.com/lorenhaim/keystone/pull/2792) Thanks [@Vultraz](https://github.com/Vultraz)! - Fixed a broken link.
...
- [`f0148ccb`](https://github.com/lorenhaim/keystone/commit/f0148ccb03abb882195b9bd44c34b780170c89ef) [#2423](https://github.com/lorenhaim/keystone/pull/2423) Thanks [@Vultraz](https://github.com/Vultraz)! - Fixed items being flagged as changed even if input did not differ.
...
- [`1b3ee45e`](https://github.com/lorenhaim/keystone/commit/1b3ee45e9ec6e52329b208c73e5a3597aea69799) [#2408](https://github.com/lorenhaim/keystone/pull/2408) Thanks [@Vultraz](https://github.com/Vultraz)! - Fixed an error when creating an item with a valueless required field.
...
- [`87a17087`](https://github.com/lorenhaim/keystone/commit/87a170877d9f735d909ee91b7661fa4a10b56a59) [#2087](https://github.com/lorenhaim/keystone/pull/2087) - Show a more helpful error in the AdminUI when the list page overflows the available number of items.
...
- [b822d229](https://github.com/lorenhaim/keystone/commit/b822d229): fix issue related to react-toast-notifications update. toasts are not triggered after delete success.
...
- [42c3fbc9](https://github.com/lorenhaim/keystone/commit/42c3fbc9): Fixing minor potential perf issue, flagged by DeepCheck
...
- [a6c3ac0c](https://github.com/lorenhaim/keystone/commit/a6c3ac0c):
...
- [abce2e6c](https://github.com/lorenhaim/keystone/commit/abce2e6c):

  `<Field>` views now receive a `savedValue` prop representing the current state as saved to the database.

- [30c1b1e1](https://github.com/lorenhaim/keystone/commit/30c1b1e1):
...
- [991c6df0](https://github.com/lorenhaim/keystone/commit/991c6df0):
...
- [adec8047](https://github.com/lorenhaim/keystone/commit/adec8047):

  Use babel-preset-react-app in the Admin UI

- [7a513e8f](https://github.com/lorenhaim/keystone/commit/7a513e8f):
...
- [18b88df0](https://github.com/lorenhaim/keystone/commit/18b88df0):

  Fix a bug with admin UI serving in production

- [ebb858a5](https://github.com/lorenhaim/keystone/commit/ebb858a5):

  - Optimistically open Nested Create Item Modal and show loading spinner

- [b8fc0a22](https://github.com/lorenhaim/keystone/commit/b8fc0a22):
...
- [119448fc](https://github.com/lorenhaim/keystone/commit/119448fc):
...
- [5e7d1940](https://github.com/lorenhaim/keystone/commit/5e7d1940):

  - Remove custom context menu on list page

- [c79cd7eb](https://github.com/lorenhaim/keystone/commit/c79cd7eb):

  - Update Many modal shows spinner while loading fields

- [51a0d853](https://github.com/lorenhaim/keystone/commit/51a0d853):
...
* [5637518f](https://github.com/lorenhaim/keystone/commit/5637518f):

  - Show loading spinner while loading views in List Table

* [997c0b9c](https://github.com/lorenhaim/keystone/commit/997c0b9c):
...
- [patch][2e227a73](https://github.com/lorenhaim/keystone/commit/2e227a73):

  - Correctly handle async .getValue() calls when saving

- [minor][e75c105c](https://github.com/lorenhaim/keystone/commit/e75c105c):
...
- [patch][545c9464](https://github.com/lorenhaim/keystone/commit/545c9464):

  - Add support for mass update

- Updated dependencies [545c9464](https://github.com/lorenhaim/keystone/commit/545c9464):
...
- Updated dependencies [4131e232](https://github.com/lorenhaim/keystone/commit/4131e232):
  - @keystone-alpha/field-views-loader@2.0.0

## 3.0.4

- [patch][d718c016](https://github.com/lorenhaim/keystone/commit/d718c016):
...
- Updated dependencies [85cb44a9](https://github.com/lorenhaim/keystone/commit/85cb44a9):
...
- [patch][f12a2a80](https://github.com/lorenhaim/keystone/commit/f12a2a80):

  - Fix running Babel on Admin UI src when on npm

## 3.0.0

- [major][9a9f214a](https://github.com/lorenhaim/keystone/commit/9a9f214a):
...
- [major][4ed35dfd](https://github.com/lorenhaim/keystone/commit/4ed35dfd):
...
- [major][dcb93771](https://github.com/lorenhaim/keystone/commit/dcb93771):
