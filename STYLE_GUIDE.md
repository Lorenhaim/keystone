...
- Published on the [GitHub repo](https://github.com/lorenhaim/keystone)
...
- Links to _other files in the monorepo_ must use..
  - An absolute file path from the monorepo root
    - Eg. `/docs/api/hooks.md` (**not** `https://www.keystonejs.com/guides/hooks` or `https://github.com/lorenhaim/keystone/blob/master/docs/guides/hooks.md`, etc.)
